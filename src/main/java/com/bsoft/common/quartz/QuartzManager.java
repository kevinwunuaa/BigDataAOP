...
public class QuartzManager {
    ...
    public static JobDetail addJob(String jobName, String jobGroupName, 
            String triggerName, String triggerGroupName, Class jobClass, String cron,Map<String,Object> args) { 
    	log.info(String.format("启动job[%s]。", jobName));
    ...
    public static void removeJob(String jobName, String jobGroupName,  
    	...
    	log.info(String.format("移除job[%s]。", jobName));
        try {  
            Scheduler sched = schedulerFactory.getScheduler();  
